...
venue: "Università di Parma"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Main Teaching building of the School of Engineering (sede didattica di Ingegneria), Teaching Room n. 9, University of Parma Campus of Science and Technology, Parco Area delle Scienze, 69/4, 43124 Parma"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "it"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "44.765092,10.311768"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "July 4-5, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30 am - 16:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Marianne Corvellec", "Nilani Ganeshwaran"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Baha Thabet"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["francois@carpentries.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-07-04-parma            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<ul class="nav nav-tabs nav-justified" role="tablist">
    <li role="presentation" class="active"><a data-os="windows" href="#spreadsheets-windows" aria-controls="Windows" role="tab" data-toggle="tab">Windows</a></li>
          <li role="presentation"><a data-os="macos" href="#spreadsheets-macos" aria-controls="MacOS" role="tab" data-toggle="tab">MacOS</a></li>
      <li role="presentation"><a data-os="linux" href="#spreadsheets-linux" aria-controls="Linux" role="tab" data-toggle="tab">Linux</a></li>
    </ul>

   <div class="tab-content">
    <ul>
    <li>Download the Installer.</li>
    <li>Install LibreOffice by going to <a href="https://www.libreoffice.org/download/libreoffice-fresh/">the installation page</a>. The correct version for your operating system  should automatically be selected. Click Download Version X.X.X (whichever is the most recent version). You will go to a page that asks about a donation, but you don't need to make one. Your download should begin automatically.</li>
